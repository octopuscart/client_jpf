...
<div class="banner1" style='background: url("<?php echo base_url(); ?>assets/measurement/measurementheader.jpg");background-size: cover;'>
    <div class="container">
        <h3><a href="/">Home</a> / <span>How To Measure</span></h3>
    </div>
</div>
                                        ...
                                        <div class="product-thumb-info row">
                                            <div class="col-md-3">
                                                <div class="product-thumb-info-image">
                                                    <img alt="" class="img-responsive" src="<?php echo base_url(); ?>/assets/measurement/<?php echo $value['image']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
